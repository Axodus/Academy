...
import { academyData, getLearningPath, getTutor } from "../services/academyData";
...
export function LearningPathViewer() {
  ...
  const courses = path.courseIds
    .map((courseId) => academyData.courses.find((course) => course.id === courseId))
    ...
    <>
      ...
      <section className="academy-card p-5">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {academyData.learningPaths.map((item) => (
